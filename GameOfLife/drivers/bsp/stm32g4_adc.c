...
static int16_t adc_converted_value[ADC_NB_OF_CHANNEL_USED];//Ce tableau contient les valeurs mesurées par l'ADC pour chaque canal.
...
void BSP_ADC_init(void)
{
	...
	//D�clenchements de l'ADC par le TIMER6 (TRGO)
	...
	//__NVIC_EnableIRQ(ADC1_2_IRQn);	//si on souhaite d�clencher une IT apr�s chaque conversion
	...
	HAL_ADC_Start_DMA(&hadc,(uint16_t*)adc_converted_value,ADC_NB_OF_CHANNEL_USED);
}
